...
Route::group(['middelware' => 'auth:sanctum'], function () {
    Route::group(['middleware' => 'verification'], function () {
        ...
        Route::get('states', 'ServiceController@states');
        Route::get('myAddress', 'ServiceController@myAddress');

        Route::post('address', 'ServiceController@address');
        ...
        Route::post('review/add', 'ServiceController@review');
