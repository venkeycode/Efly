        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="th-hero-bg" data-bg-src="{{asset('website') }}/assets/img/hero/hero_bg_3_1.jpg">
                    </div>
                    <div class="container">
                        <div class="hero-style3">
                            ...
                            <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.4s">Agamana an international
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="th-hero-bg" data-bg-src="{{asset('website') }}/assets/img/hero/hero_bg_3_2.jpg">
                    </div>
                    <div class="container">
                        <div class="hero-style3">
                            <h1 class="hero-title" data-ani="slideinleft" data-ani-delay="0.2s">
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="th-hero-bg" data-bg-src="{{asset('website') }}/assets/img/hero/hero_bg_3_3.jpg">
                    </div>
                    <div class="container">
                        <div class="hero-style3">
                            <h1 class="hero-title" data-ani="slideinleft" data-ani-delay="0.2s">
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="th-hero-bg" data-bg-src="{{asset('website') }}/assets/img/hero/hero_bg_3_4.jpg">
                    </div>
                    <div class="container">
                        <div class="hero-style3">
                            <h1 class="hero-title" data-ani="slideinleft" data-ani-delay="0.2s">
                                Explore the world with Agamana
                            </h1>
                            <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.4s">Agamana an international
                                travel management company with 25 years of
                                experience, specializing in business and maritime travel.</p>
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <video autoplay loop muted>
                        <source src="{{asset('website') }}/assets/img/hero/hero-video3.mp4" type="video/mp4">
                    </video>
                    <div class="container">
                        <div class="hero-style3">
                            <h1 class="hero-title" data-ani="slideinleft" data-ani-delay="0.2s">
                                Travel experience with Agamana
                            </h1>
                            <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.4s">Agamana an international
                                travel management company with 25 years of
                                experience, specializing in business and maritime travel.</p>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="hero-inner">
                                    <div class="hero3-card">
                                        <div class="hero-img">
                                            <img src="{{asset('website') }}/assets/img/hero/hero_bg_3_1.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="hero-inner">
                                    <div class="hero3-card">
                                        <div class="hero-img">
                                            <img src="{{asset('website') }}/assets/img/hero/hero_bg_3_2.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="hero-inner">
                                    <div class="hero3-card">
                                        <div class="hero-img">
                                            <img src="{{asset('website') }}/assets/img/hero/hero_bg_3_3.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="hero-inner">
                                    <div class="hero3-card">
                                        <div class="hero-img">
                                            <img src="{{asset('website') }}/assets/img/hero/hero_bg_3_4.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="hero-inner">
                                    <div class="hero3-card">
                                        <div class="hero-img">
                                            <img src="{{asset('website') }}/assets/img/hero/hero_bg_3_5.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="input-wrap">
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    <div class="form-btn col-md-6 col-xl-auto">
                                        <button class="th-btn"><img src="{{asset('website') }}/assets/img/icon/search.svg" alt="">Search</button>
                                    </div>
                                </div>
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-lg-5">
                ...
                <p class="sec-text mb-30">One of the most well-liked travel companies for people looking to experience
                    adventure and see the world is Agamana.</p>
            ...
            <div class="swiper th-slider has-shadow" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1300":{"slidesPerView":"4"}}}'>
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="destination-item th-ani">
                            <div class="destination-item_img global-img">
                                <img src="{{asset('website') }}/assets/img/destination/destination_3_3.jpg" alt="image">
                            </div>
                            <div class="destination-content">
                    ...
                    <div class="swiper-slide">
                        <div class="destination-item th-ani">
                            <div class="destination-item_img global-img">
                                <img src="{{asset('website') }}/assets/img/destination/destination_3_4.jpg" alt="image">
                            </div>
                            <div class="destination-content">
            ...
            <div class="swiper th-slider has-shadow category-slider3" id="categorySlider3" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"5"}}}'>
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="category-card single2">
                            <div class="box-img global-img">
                                <img src="{{asset('website') }}/assets/img/category/category_1_1.jpg" alt="Image">
                            </div>
                            <h3 class="box-title"><a href="destination.html">Swimming Pool</a></h3>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card single2">
                            <div class="box-img global-img">
                                <img src="{{asset('website') }}/assets/img/category/category_1_2.jpg" alt="Image">
                            </div>
                            <h3 class="box-title"><a href="destination.html">Walking & Cycling Trails</a></h3>
                            <a class="line-btn" href="destination.html">See more</a>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card single2">
                            <div class="box-img global-img">
                                <img src="{{asset('website') }}/assets/img/category/category_1_3.jpg" alt="Image">
                            </div>
                            <h3 class="box-title"><a href="destination.html">Campfire Nights</a></h3>
                            <a class="line-btn" href="destination.html">See more</a>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card single2">
                            <div class="box-img global-img">
                                <img src="{{asset('website') }}/assets/img/category/category_1_4.jpg" alt="Image">
                            </div>
                            <h3 class="box-title"><a href="destination.html">Dirt Bike Adventures</a></h3>
                            <a class="line-btn" href="destination.html">See more</a>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-7">
                <div class="img-box3">
                    <div class="img1">
                        <img src="{{asset('website') }}/assets/img/normal/about_3_1.jpg" alt="About">
                    </div>
                    <div class="img2">
                        <img src="{{asset('website') }}/assets/img/normal/about_3_2.jpg" alt="About">
                    </div>
                    <div class="img3 movingX">
                        <img src="{{asset('website') }}/assets/img/normal/about_3_3.jpg" alt="About">
                    </div>
                </div>
            </div>
            <div class="col-xl-5">
            ...
            <div class="col-lg-6">
                <div class="contact-form-area">
                    ...
                    <div class="form-btn-wrapp">
                        <div class="form-btn">
                            <button class="th-btn white-btn">Send Message <img src="{{asset('website') }}/assets/img/icon/plane3.svg" alt=""></button>
                        </div>
                        <div class="contact-info">
                            <p class="contact-info_link"><a href="tel:+0123456789">+91 8660991527</a></p>
