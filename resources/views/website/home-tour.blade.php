...
<div class="hero-2" id="hero">
        ...
        <div class="swiper hero-slider-2" id="heroSlide2">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_bg_2_1.jpg">
                        </div>
                        <div class="container">
                            <div class="hero-style2">
                                ...
                                <p class="hero-desc" data-ani="slideinup" data-ani-delay="0.5s">
                                    Agamana an international travel management company with 25 years of experience,
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_bg_2_3.jpg">
                        </div>
            ...
            <div class="th-swiper-custom">
                ...
                <div class="hero-icon">
                    <button data-slider-prev="#heroSlide2" class="hero-arrow slider-prev"><img src="assets/img/icon/hero-arrow-left.svg" alt=""></button>
                    <button data-slider-next="#heroSlide2" class="hero-arrow slider-next"><img src="assets/img/icon/hero-arrow-right.svg" alt=""></button>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="destination-list-area">
                    <div class="destination-list-wrap">
                        <div class="destination-list" data-bg-src="assets/img/destination/destination_2_1.jpg">
                    ...
                    <div class="destination-list-wrap">
                        <div class="destination-list" data-bg-src="assets/img/destination/destination_2_2.jpg">
                            <div class="destination-content">
                                <h4 class="box-title">
                    ...
                    <div class="destination-list-wrap">
                        <div class="destination-list" data-bg-src="assets/img/destination/destination_2_3.jpg">
                            <div class="destination-content">
                                <h4 class="box-title">
                    ...
                    <div class="destination-list-wrap active">
                        <div class="destination-list" data-bg-src="assets/img/destination/destination_2_4.jpg">
                            <div class="destination-content">
                                <h4 class="box-title">
                            ...
                            <div class="accordion-item-wrapp" id="offerDeals">
                                ...
                                <div class="accordion-item-content">
                                    <div class="accordion-tab-item" data-bs-toggle="tab" data-bs-target="#tab2">
                                        <div class="accordion-item" data-img="assets/img/normal/offer_img_2.jpg">
                                    ...
                                    <div class="accordion-item-content">
                                        <div class="accordion-tab-item" data-bs-toggle="tab" data-bs-target="#tab3">
                                            <div class="accordion-item " data-img="assets/img/normal/offer_img_3.jpg">
                                    ...
                                    <div class="accordion-item-content">
                                        <div class="accordion-tab-item" data-bs-toggle="tab" data-bs-target="#tab4">
                                            <div class="accordion-item" data-img="assets/img/normal/offer_img_4.jpg">
                                    ...
                                    <div class="accordion-item-content">
                                        <div class="accordion-tab-item" data-bs-toggle="tab" data-bs-target="#tab5">
                                            <div class="accordion-item" data-img="assets/img/normal/offer_img_5.jpg">
...
==============================-->
    ...
    <section class="tour-sec2 position-relative overflow-hidden bg-top-center z-index-3 space-top" id="tour-sec" data-pos-for=".counter-sec2" data-sec-pos="bottom-half" data-bg-src="assets/img/bg/tour_bg_2.jpg">
        <div class="container">
            ...
            <div class="slider-area tour-slider">
                <div class="swiper th-slider tourSlider2 has-shadow" id="tourSlider2" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"480":{"slidesPerView":2},"576":{"slidesPerView":"2"},"1199":{"slidesPerView":"3"},"1400":{"slidesPerView":"4"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="tour-card th-ani  gsap-cursor">
                                ...
                                <div class="tour-content">
                                    ...
                                    <div class="tour-action">
                                        <span><i class="fa-light fa-clock"></i>7 Days</span>
                                        <a href="tour-details.html" class="th-btn style4">Book Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Gallery Area
==============================-->
    <div class=" bg-top-center space" data-bg-src="assets/img/bg/gallery_bg_1.jpg">
        <div class="container">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-7">
                        <div class="title-area mb-md-0">
                            ...
                            <h2 class="sec-title">News & Articles From Agamana</h2>
                        </div>
                    </div>
