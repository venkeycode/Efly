                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="about-contact-grid style2">
                        ...
                        <div class="about-contact-details">
                            ...
                            <p class="about-contact-details-text">{{$site->address}} </p>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="about-contact-grid">
                        ...
                        <div class="about-contact-details">
                            ...
                            <p class="about-contact-details-text"><a href="tel:01234567890">{{$site->phone}}</a></p>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="about-contact-grid">
                        ...
                        <div class="about-contact-details">
                            ...
                            <p class="about-contact-details-text"><a href="mailto:mailinfo00@Agamana.com">{{$site->email}}</a></p>
...
Video Area
==============================-->
    <div class="space-extra2-top space-extra2-bottom" data-bg-src="{{asset('website') }}/assets/img/bg/video_bg_1.jpg">
        <div class="container">
            <div class="row flex-row-reverse justify-content-center align-items-center">
                ...
                <div class="col-lg-6">
                    <div>
                        <form action="{{route('contact.submit')}}" method="POST" class="contact-form style2 ">
                        @csrf
