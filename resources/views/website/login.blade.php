                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="about-contact-grid">
                        ...
                        <div class="about-contact-details">
                            ...
                            <p class="about-contact-details-text"><a href="mailto:mailinfo00@Agamana.com">info@agamana.com</a></p>
            ...
            <div class="row flex-row-reverse justify-content-center align-items-center">
                ...
                <div class="col-lg-6">
                    <div>
                        ...
                        @csrf
                        <h3 class="sec-title mb-30 text-capitalize">Login</h3>
                            <div class="row">
                                ...
                                <div class="col-12 form-group">
                                    <input type="mobile" class="form-control" name="mobile" placeholder="Mobile Number" required>
                                    <img src="{{asset('website') }}/assets/img/icon/mail.svg" alt="">
                                </div>
                                <div class="col-12 form-group">
                                ...
                                <div class="form-btn col-12 mt-24"><button type="submit" class="th-btn style3">Login
                                        <img src="{{asset('website') }}/assets/img/icon/plane.svg" alt=""></button>
                                        <a href="{{route('register')}}">Don't have account ? </a>
                                </div>
                            </div>

                            <p class="form-messages mb-0 mt-3"> Register</p>
                        </form>
                    </div>
                </div>
            </div>
